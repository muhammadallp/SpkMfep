...
<body onload="window.print();">
    ...
    <h4><b>LAPORAN DATA BARANG KELUAR</b></h4>
 ...
 <br>
  ...
  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                      if(isset($_POST['b1'])){
                        $sql=mysqli_query($koneksi,"SELECT * FROM barang_keluar INNER JOIN barang ON barang_keluar.id_barang=barang.id_barang INNER JOIN kategori ON barang_keluar.id_kategori=kategori.id WHERE date(tanggal) between '$_POST[tgl1]' and '$_POST[tgl2]' ORDER BY tanggal desc ");
