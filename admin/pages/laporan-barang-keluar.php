            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data List Barang Keluar</h3>  
                </div><!-- /.box-header -->
                    <div class="box-header">
                    <div class="row">
                      <div class="col-md-12">
                      <form action="#" method="post">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-1"><a href="./pages/cetak-barang-keluar.php?tgl1=<?php echo $_POST['tanggal1']; ?>&&tgl2=<?php echo $_POST['tanggal2']; ?>" target="_blank" class="btn btn-warning"><i class="fa fa-print"></i> Cetak</a>
                          </div>
                          <?php } ?>
                      </form>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                        if(isset($_POST['b1'])){
                    $sql=mysqli_query($koneksi,"SELECT * FROM barang_keluar INNER JOIN barang ON barang_keluar.id_barang=barang.id_barang INNER JOIN kategori ON barang_keluar.id_kategori=kategori.id WHERE date(tanggal) between '$_POST[tanggal1]' and '$_POST[tanggal2]' ORDER BY tanggal desc ");
                          //  $sql=mysqli_query($koneksi,"SELECT * FROM barang_masuk m, barang b where  b.id_barang = m.id_barang ORDER BY tgl desc");
                        }else{
                            $sql=mysqli_query($koneksi,"SELECT * FROM barang_keluar INNER JOIN barang ON barang_keluar.id_barang=barang.id_barang INNER JOIN kategori ON barang_keluar.id_kategori=kategori.id ORDER BY tgl desc");        
                        }
